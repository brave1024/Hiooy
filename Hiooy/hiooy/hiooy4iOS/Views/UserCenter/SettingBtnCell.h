...
@class SettingBtnCell;

@protocol SettingBtnCellDelegate <TableViewCellDelegate>

- (void)clickCellWithKey:(NSString *)keyForCell;

@end

@interface SettingBtnCell : UITableViewCell
...
@property (nonatomic, assign) id<SettingBtnCellDelegate> delegate;
